...
(COMMON-LISP:EXPORT
 '(A ABPP ADVANCEX ALIAS ALPHA ALPHAMASK ANIM ANIMATIONS ANIMCOUNT ANIMNORMALS
   ...
   RAYCOLLISION RAYCOLLISION RAYLIB_VERSION_MAJOR RAYLIB_VERSION_MINOR
   RAYLIB_VERSION_PATCH RBPP REC REC1 REC2 RECS RECTANGLE RECTANGLE
   RENDERTEXTURE RENDERTEXTURE RENDERTEXTURE2D REPLACE RESTOREWINDOW
   ...
   __BUILTIN_VA_LIST __GCC_HAVE_DWARF2_CFI_ASM __GNUC_VA_LIST)
 '#:AF-RAYLIB.LIB)
...
(COMMON-LISP:DEFPARAMETER +CONSTANT-NAMES+
  '(("FALSE" . FALSE) ("TRUE" . TRUE)
    ...
    ("__GCC_HAVE_DWARF2_CFI_ASM" . __GCC_HAVE_DWARF2_CFI_ASM) ("PI" . PI)
